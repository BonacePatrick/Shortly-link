    ...
    <>
         <div className="navbar bg-base-100">
            <div className="navbar-start">
                ...
                <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
                    ...
                    <li><a href='#' className='text-grayishViolet hover:text-veryDarkViolet'>Features</a></li>
                    <li><a href='#' className='text-grayishViolet hover:text-veryDarkViolet'>Pricing</a></li>
                    <li><a href='#' className='text-grayishViolet hover:text-veryDarkViolet'>Resources</a></li>
                    
                </ul>
                </div>
                <a href='#' className="lg:ml-10"><img className='w-3/4 lg:w-full' src="./assets/logo.svg" alt="logo" /></a>
            </div>
            ...
            <label htmlFor="my-modal-1" className="hover:text-veryDarkViolet">Log in</label>

            <label htmlFor="my-modal-2" className="px-6 py-2 lg:px-8 lg:py-3 font-bold text-white bg-cyan 
                rounded-full hover:opacity-70">Sign up</label>
            ...
            <button type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Log in</button>
                ...
                <label htmlFor="my-modal-1" className="bg-slate-600 py-2 px-4 text-white border-none rounded-xl">Close</label>
                </div>
            </div>
            </div>
         ...
         <input type="checkbox" id="my-modal-2" className="modal-toggle" />
            ...
            <button type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Sign up</button>
                ...
                <div className="modal-action">
                <label htmlFor="my-modal-2" className="bg-slate-600 py-2 px-4 text-white border-none rounded-xl">Close</label>
                </div>
            </div>
            </div>    
